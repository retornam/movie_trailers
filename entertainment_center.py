...
# This Class uses the Movie structure from media.py to create instances of
# movies and calls the function open_movies_page from fresh_tomatoes.py to
# generate the corresponting html page.

# imports Movie class from media.py
from media import Movie

# imports open_movies_page function from fresh_tomatoes.py
from fresh_tomatoes import open_movies_page

# creating instances of movies to be displayed on the html page
movie1 = Movie(
    "Furious 7",
    ...
    "https://www.youtube.com/watch?v=dKi5XoeTN0k", '''
        After defeating international terrorist Owen Shaw,
...
movie2 = Movie(
    "Focus",
    "http://ia.media-imdb.com/images/M/MV5BMTUwODg2OTA4OF5BMl5BanBnXkFtZTgwOTE5MTE4MzE@._V1_SX214_AL_.jpg",  # noqa
...
# creating list of movies to be used to generate html file
movies = [movie1, movie2, movie3]

# calling open_movies_page from fresh_tomatoes.py to generate html page
